...
var Dajaxice = {
    ...
    favorite: function(callback_function, argv, custom_settings){
        return Dajaxice.call('neighborhood.favorite', 'POST', callback_function, argv, custom_settings);
    },
	
	is_favorite: function(callback_function, argv, custom_settings){
        return Dajaxice.call('neighborhood.is_favorite', 'GET', callback_function, argv, custom_settings);
    },
	
	filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('neighborhood.filter', 'GET', callback_function, argv, custom_settings);
    }
